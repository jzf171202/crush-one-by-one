...
public class LruCache<K, V> {
     ...
     *
     * @param evicted
     *         true if the entry is being removed to make space, false if the removal was caused by
     *         a {@link #put} or {@link #remove}. true---为释放空间被删除；false---put或remove导致
     * @param newValue
     *         the new value for {@code key}, if it exists. If non-null, this removal was caused by
     *         a {@link #put}. Otherwise it was caused by an eviction or a {@link #remove}.
     */
