 ...
 *******************************************************************************/
package com.jzf.image.cache.disc.impl;
...
/**
 * Default implementation of {@linkplain com.jzf.image.cache.disc.DiskCache disk cache}.
...
public class UnlimitedDiskCache extends BaseDiskCache {
     ...
     * @param cacheDir          Directory for file caching
     * @param reserveCacheDir   null-ok; Reserve directory for file caching. It's used when the primary directory isn't available.
     * @param fileNameGenerator {@linkplain com.jzf.image.cache.disc.naming.FileNameGenerator
