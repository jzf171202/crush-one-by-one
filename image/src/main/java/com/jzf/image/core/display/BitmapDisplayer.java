...
/**
 * Displays {@link Bitmap} in {@link com.jzf.image.core.imageaware.ImageAware}. Implementations can
 * apply some changes to Bitmap or any animation for displaying Bitmap.<br />
 * Implementations have to be thread-safe.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see com.jzf.image.core.imageaware.ImageAware
 * @see com.jzf.image.core.assist.LoadedFrom
 * @since 1.5.6
 */
