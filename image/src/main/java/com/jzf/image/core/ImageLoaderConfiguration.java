...
import com.jzf.image.cache.memory.impl.FuzzyKeyMemoryCache;
import com.jzf.image.core.assist.FlushedInputStream;
import com.jzf.image.core.assist.ImageSize;
import com.jzf.image.core.assist.QueueProcessingType;
import com.jzf.image.core.decode.ImageDecoder;
import com.jzf.image.core.download.ImageDownloader;
import com.jzf.image.core.process.BitmapProcessor;
import com.jzf.image.utils.L;
import com.jzf.image.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.jzf.image.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.jzf.image.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.jzf.image.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.jzf.image.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.jzf.image.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.jzf.image.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.jzf.image.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.jzf.image.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.jzf.image.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.jzf.image.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.jzf.image.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.jzf.image.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.jzf.image.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.jzf.image.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
