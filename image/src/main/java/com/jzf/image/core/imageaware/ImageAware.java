 ...
 *******************************************************************************/
package com.jzf.image.core.imageaware;
 ...
 * through {@link com.jzf.image.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.jzf.image.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.jzf.image.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.jzf.image.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.jzf.image.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain com.jzf.image.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain com.jzf.image.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.jzf.image.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.jzf.image.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.jzf.image.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
