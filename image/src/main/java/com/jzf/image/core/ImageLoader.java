...
import com.jzf.image.core.assist.FailReason;
...
import com.jzf.image.core.assist.ViewScaleType;
import com.jzf.image.core.imageaware.ImageAware;
import com.jzf.image.core.imageaware.ImageViewAware;
import com.jzf.image.core.imageaware.NonViewAware;
import com.jzf.image.core.listener.ImageLoadingListener;
import com.jzf.image.core.listener.ImageLoadingProgressListener;
import com.jzf.image.core.listener.SimpleImageLoadingListener;
import com.jzf.image.utils.ImageSizeUtils;
...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain com.jzf.image.core.imageaware.ImageAware Image aware view}
     ...
     * @param imageAware {@linkplain com.jzf.image.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param options    {@linkplain com.jzf.image.core.DisplayImageOptions Options} for image
     ...
     * @param progressListener {@linkplain com.jzf.image.core.listener.ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI thread if this method
     *                         is called on UI thread. Caching on disk should be enabled in
     *                         {@linkplain com.jzf.image.core.DisplayImageOptions options} to make
     *                         this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
     ...
     * {@link com.jzf.image.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.jzf.image.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.jzf.image.core.imageaware.ImageAware ImageAware} for
     ...
     * {@linkplain com.jzf.image.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
