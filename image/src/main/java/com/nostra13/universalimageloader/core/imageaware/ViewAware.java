...
public abstract class ViewAware implements ImageAware {
	 ...
	 *                            save memory.
	 */
	public ViewAware(android.view.View view, boolean checkActualViewSize) {
		if (view == null) throw new IllegalArgumentException("view must not be null");

		this.viewRef = new java.lang.ref.WeakReference<android.view.View>(view);
	...
	public int getWidth() {
		...
		if (view != null) {
			final android.view.ViewGroup.LayoutParams params = view.getLayoutParams();
			int width = 0;
			if (checkActualViewSize && params != null && params.width != android.view.ViewGroup.LayoutParams.WRAP_CONTENT) {
	...
	public int getHeight() {
		...
		if (view != null) {
			final android.view.ViewGroup.LayoutParams params = view.getLayoutParams();
			int height = 0;
			if (checkActualViewSize && params != null && params.height != android.view.ViewGroup.LayoutParams.WRAP_CONTENT) {
	...
	public com.nostra13.universalimageloader.core.assist.ViewScaleType getScaleType() {
		return com.nostra13.universalimageloader.core.assist.ViewScaleType.CROP;
	}
	...
	public boolean setImageDrawable(android.graphics.drawable.Drawable drawable) {
		if (android.os.Looper.myLooper() == android.os.Looper.getMainLooper()) {
			...
			com.nostra13.universalimageloader.utils.L.w(WARN_CANT_SET_DRAWABLE);
		}
		return false;
	}
	...
	public boolean setImageBitmap(android.graphics.Bitmap bitmap) {
		if (android.os.Looper.myLooper() == android.os.Looper.getMainLooper()) {
			...
			com.nostra13.universalimageloader.utils.L.w(WARN_CANT_SET_BITMAP);
		}
		return false;
	}
