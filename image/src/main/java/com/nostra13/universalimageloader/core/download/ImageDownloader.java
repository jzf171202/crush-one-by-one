...
public interface ImageDownloader {
	 ...
	 */
	java.io.InputStream getStream(String imageUri, Object extra) throws java.io.IOException;
	...
	public enum Scheme {
		...
		public static com.nostra13.universalimageloader.core.download.ImageDownloader.Scheme ofUri(String uri) {
			if (uri != null) {
				for (com.nostra13.universalimageloader.core.download.ImageDownloader.Scheme s : values()) {
					if (s.belongsTo(uri)) {
						return s;
					}
				}
		...
		private boolean belongsTo(String uri) {
			return uri.toLowerCase(java.util.Locale.US).startsWith(uriPrefix);
		}
