...
public class ImageSize {
	...
	public com.nostra13.universalimageloader.core.assist.ImageSize scaleDown(int sampleSize) {
		return new com.nostra13.universalimageloader.core.assist.ImageSize(width / sampleSize, height / sampleSize);
	}

	/** Scales dimensions according to incoming scale. Returns new object. */
	public com.nostra13.universalimageloader.core.assist.ImageSize scale(float scale) {
		return new com.nostra13.universalimageloader.core.assist.ImageSize((int) (width * scale), (int) (height * scale));
	}
