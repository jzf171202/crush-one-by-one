...
public class ImageDecodingInfo {
	...
	public ImageDecodingInfo(String imageKey, String imageUri, String originalImageUri, com.nostra13.universalimageloader.core.assist.ImageSize targetSize, com.nostra13.universalimageloader.core.assist.ViewScaleType viewScaleType,
	...
	private void copyOptions(android.graphics.BitmapFactory.Options srcOptions, android.graphics.BitmapFactory.Options destOptions) {
		...
		if (android.os.Build.VERSION.SDK_INT >= 10) copyOptions10(srcOptions, destOptions);
		if (android.os.Build.VERSION.SDK_INT >= 11) copyOptions11(srcOptions, destOptions);
	}

	@android.annotation.TargetApi(10)
	private void copyOptions10(android.graphics.BitmapFactory.Options srcOptions, android.graphics.BitmapFactory.Options destOptions) {
		destOptions.inPreferQualityOverSpeed = srcOptions.inPreferQualityOverSpeed;
	}

	@android.annotation.TargetApi(11)
	private void copyOptions11(android.graphics.BitmapFactory.Options srcOptions, android.graphics.BitmapFactory.Options destOptions) {
