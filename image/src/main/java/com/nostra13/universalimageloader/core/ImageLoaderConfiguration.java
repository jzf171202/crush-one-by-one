...
public final class ImageLoaderConfiguration {
	...
	final com.nostra13.universalimageloader.core.process.BitmapProcessor processorForDiskCache;
	...
	final com.nostra13.universalimageloader.core.assist.QueueProcessingType tasksProcessingType;

	final MemoryCache memoryCache;
	final DiskCache diskCache;
	final com.nostra13.universalimageloader.core.download.ImageDownloader downloader;
	final com.nostra13.universalimageloader.core.decode.ImageDecoder decoder;
	final com.nostra13.universalimageloader.core.DisplayImageOptions defaultDisplayImageOptions;

	final com.nostra13.universalimageloader.core.download.ImageDownloader networkDeniedDownloader;
	final com.nostra13.universalimageloader.core.download.ImageDownloader slowNetworkDownloader;

	private ImageLoaderConfiguration(final com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder builder) {
		...
		networkDeniedDownloader = new com.nostra13.universalimageloader.core.ImageLoaderConfiguration.NetworkDeniedImageDownloader(downloader);
		slowNetworkDownloader = new com.nostra13.universalimageloader.core.ImageLoaderConfiguration.SlowNetworkImageDownloader(downloader);

		com.nostra13.universalimageloader.utils.L.writeDebugLogs(builder.writeLogs);
	}
	 ...
	 * </ul>
	 */
	public static com.nostra13.universalimageloader.core.ImageLoaderConfiguration createDefault(android.content.Context context) {
		return new com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder(context).build();
	}

	com.nostra13.universalimageloader.core.assist.ImageSize getMaxImageSize() {
		...
		return new com.nostra13.universalimageloader.core.assist.ImageSize(width, height);
	}
	...
	public static class Builder {
		...
		/** {@value} */
		public static final com.nostra13.universalimageloader.core.assist.QueueProcessingType DEFAULT_TASK_PROCESSING_TYPE = com.nostra13.universalimageloader.core.assist.QueueProcessingType.FIFO;
		...
		private com.nostra13.universalimageloader.core.process.BitmapProcessor processorForDiskCache = null;

		private java.util.concurrent.Executor taskExecutor = null;
		private java.util.concurrent.Executor taskExecutorForCachedImages = null;
		...
		private com.nostra13.universalimageloader.core.assist.QueueProcessingType tasksProcessingType = DEFAULT_TASK_PROCESSING_TYPE;
		...
		private com.nostra13.universalimageloader.core.download.ImageDownloader downloader = null;
		private com.nostra13.universalimageloader.core.decode.ImageDecoder decoder;
		private com.nostra13.universalimageloader.core.DisplayImageOptions defaultDisplayImageOptions = null;
		 ...
		 */
		@Deprecated
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder discCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache,
                                                                                                             com.nostra13.universalimageloader.core.process.BitmapProcessor processorForDiskCache) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder diskCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache,
                                                                                                             com.nostra13.universalimageloader.core.process.BitmapProcessor processorForDiskCache) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder taskExecutor(java.util.concurrent.Executor executor) {
			if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_EXECUTOR);
			}
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder taskExecutorForCachedImages(java.util.concurrent.Executor executorForCachedImages) {
			if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority != DEFAULT_THREAD_PRIORITY || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_EXECUTOR);
			}
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder tasksProcessingOrder(com.nostra13.universalimageloader.core.assist.QueueProcessingType tasksProcessingType) {
			if (taskExecutor != null || taskExecutorForCachedImages != null) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_EXECUTOR);
			}
		...
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder memoryCacheSize(int memoryCacheSize) {
			...
			if (memoryCache != null) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_MEMORY_CACHE);
			}
		 ...
		 * {@link MemoryCache}.
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder memoryCacheSizePercentage(int availableMemoryPercent) {
		 ...
		 * </ul>
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder memoryCache(MemoryCache memoryCache) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder diskCacheSize(int maxCacheSize) {
			if (maxCacheSize <= 0) throw new IllegalArgumentException("maxCacheSize must be a positive number");

			if (diskCache != null) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_DISK_CACHE_PARAMS);
			}
		 ...
		 * implementation of {@link DiskCache}
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder diskCacheFileCount(int maxFileCount) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder diskCacheFileNameGenerator(FileNameGenerator fileNameGenerator) {
			if (diskCache != null) {
				com.nostra13.universalimageloader.utils.L.w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR);
			}
		...
		@Deprecated
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder discCache(DiskCache diskCache) {
		 ...
		 * </ul>
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder diskCache(DiskCache diskCache) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder imageDownloader(com.nostra13.universalimageloader.core.download.ImageDownloader imageDownloader) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder imageDecoder(com.nostra13.universalimageloader.core.decode.ImageDecoder imageDecoder) {
		 ...
		 */
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder defaultDisplayImageOptions(com.nostra13.universalimageloader.core.DisplayImageOptions defaultDisplayImageOptions) {
		...
		public com.nostra13.universalimageloader.core.ImageLoaderConfiguration build() {
			initEmptyFieldsWithDefaultValues();
			return new com.nostra13.universalimageloader.core.ImageLoaderConfiguration(this);
		}
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (denyCacheImageMultipleSizesInMemory) {
				memoryCache = new FuzzyKeyMemoryCache(memoryCache, com.nostra13.universalimageloader.utils.MemoryCacheUtils.createFuzzyKeyComparator());
			}
			if (downloader == null) {
			...
			if (defaultDisplayImageOptions == null) {
				defaultDisplayImageOptions = com.nostra13.universalimageloader.core.DisplayImageOptions.createSimple();
			}
		}
	}
	 ...
	 * @since 1.8.0
	 */
	private static class NetworkDeniedImageDownloader implements com.nostra13.universalimageloader.core.download.ImageDownloader {

		private final com.nostra13.universalimageloader.core.download.ImageDownloader wrappedDownloader;

		public NetworkDeniedImageDownloader(com.nostra13.universalimageloader.core.download.ImageDownloader wrappedDownloader) {
	 ...
	 * @since 1.8.1
	 */
	private static class SlowNetworkImageDownloader implements com.nostra13.universalimageloader.core.download.ImageDownloader {

		private final com.nostra13.universalimageloader.core.download.ImageDownloader wrappedDownloader;

		public SlowNetworkImageDownloader(com.nostra13.universalimageloader.core.download.ImageDownloader wrappedDownloader) {
			this.wrappedDownloader = wrappedDownloader;
		}

		@Override
		public java.io.InputStream getStream(String imageUri, Object extra) throws java.io.IOException {
			java.io.InputStream imageStream = wrappedDownloader.getStream(imageUri, extra);
			switch (com.nostra13.universalimageloader.core.download.ImageDownloader.Scheme.ofUri(imageUri)) {
				case HTTP:
				case HTTPS:
					return new com.nostra13.universalimageloader.core.assist.FlushedInputStream(imageStream);
				default:
					return imageStream;
			}
		}
