...
public class FailReason {
	...
	private final com.nostra13.universalimageloader.core.assist.FailReason.FailType type;

	private final Throwable cause;

	public FailReason(com.nostra13.universalimageloader.core.assist.FailReason.FailType type, Throwable cause) {
		this.type = type;
		this.cause = cause;
	}

	/** @return {@linkplain FailType Fail type} */
	public com.nostra13.universalimageloader.core.assist.FailReason.FailType getType() {
		return type;
	}
