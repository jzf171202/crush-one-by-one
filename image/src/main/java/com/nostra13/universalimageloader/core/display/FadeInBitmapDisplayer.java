 ...
 * @since 1.6.4
 */
public class FadeInBitmapDisplayer implements com.nostra13.universalimageloader.core.display.BitmapDisplayer {
	...
	public void display(android.graphics.Bitmap bitmap, ImageAware imageAware, com.nostra13.universalimageloader.core.assist.LoadedFrom loadedFrom) {
		...
		if ((animateFromNetwork && loadedFrom == com.nostra13.universalimageloader.core.assist.LoadedFrom.NETWORK) ||
				(animateFromDisk && loadedFrom == com.nostra13.universalimageloader.core.assist.LoadedFrom.DISC_CACHE) ||
				(animateFromMemory && loadedFrom == com.nostra13.universalimageloader.core.assist.LoadedFrom.MEMORY_CACHE)) {
	 ...
	 */
	public static void animate(android.view.View imageView, int durationMillis) {
		if (imageView != null) {
			android.view.animation.AlphaAnimation fadeImage = new android.view.animation.AlphaAnimation(0, 1);
			fadeImage.setDuration(durationMillis);
			fadeImage.setInterpolator(new android.view.animation.DecelerateInterpolator());
