...
public final class L {
	...
	public static void writeDebugLogs(boolean writeDebugLogs) {
		com.nostra13.universalimageloader.utils.L.writeDebugLogs = writeDebugLogs;
	}

	/** Enables/disables logging of {@link ImageLoader} completely (even error logs). */
	public static void writeLogs(boolean writeLogs) {
		com.nostra13.universalimageloader.utils.L.writeLogs = writeLogs;
	}
	...
	public static void e(Throwable ex) {
		log(android.util.Log.ERROR, ex, null);
	}
	...
	private static void log(int priority, Throwable ex, String message, Object... args) {
		...
		android.util.Log.println(priority, ImageLoader.TAG, log);
	}
}