...
public final class MemoryCacheUtils {
	...
	public static java.util.Comparator<String> createFuzzyKeyComparator() {
	 ...
	 */
	public static java.util.List<android.graphics.Bitmap> findCachedBitmapsForImageUri(String imageUri, MemoryCache memoryCache) {
		java.util.List<android.graphics.Bitmap> values = new java.util.ArrayList<android.graphics.Bitmap>();
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static java.util.List<String> findCacheKeysForImageUri(String imageUri, MemoryCache memoryCache) {
	...
	public static void removeFromCache(String imageUri, MemoryCache memoryCache) {
		java.util.List<String> keysToRemove = new java.util.ArrayList<String>();
		for (String key : memoryCache.keys()) {
			if (key.startsWith(imageUri)) {
