 ...
 * @since 1.4.0
 */
public class Md5FileNameGenerator implements com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator {
	...
	public String generate(String imageUri) {
		...
		java.math.BigInteger bi = new java.math.BigInteger(md5).abs();
