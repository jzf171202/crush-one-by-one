...
public class UsingFreqLimitedMemoryCache extends LimitedMemoryCache {
	 ...
	 */
	private final java.util.Map<android.graphics.Bitmap, Integer> usingCounts = java.util.Collections.synchronizedMap(new java.util.HashMap<android.graphics.Bitmap, Integer>());
	...
	protected android.graphics.Bitmap removeNext() {
		...
		android.graphics.Bitmap leastUsedValue = null;
		java.util.Set<java.util.Map.Entry<android.graphics.Bitmap, Integer>> entries = usingCounts.entrySet();
